...
export const TAG_INDEX: Record<string, TagContentItem[]> = {
  ...
  projects: [
    ...
    {
      label: "explain project market",
      type: "command",
      command: "explain project market",
    },
    {
      label: "explain project wasm",
      type: "command",
  ...
  writing: [
    ...
    {
      label: "Terminal portfolio changelog",
      type: "post",
      command: "cat /posts/2026/04/29/terminal-portfolio-changelog.md",
    },
  ...
  wasm: [
    ...
    {
      label: "WASM project file",
      type: "file",
      command: "cat /projects/webassembly-runtime.md",
    },
  ],
  ai: [
...
export function getItemsForTag(slug: string): TagContentItem[] | null {
  ...
  const partial = Object.keys(TAG_INDEX).filter(
...
const TAG_DESCRIPTIONS: Record<string, string> = {
  ...
  architecture:
    "Architecture notes, system structure, and implementation design.",
  ...
  devops:
    "Automation, operations, delivery workflows, and platform maintenance.",
  document: "Document-style outputs such as the resume and downloads.",
  engineering:
    "General engineering capability, implementation depth, and systems work.",
  ...
  projects:
    "Project pages, project files, and project-specific explainer commands.",
  ...
  system:
    "Shell behavior, process/state inspection, and system-level utilities.",
  terminal:
    "Terminal-native commands, shell UI, and interactive workflow surfaces.",
  theme: "Theme palettes, palette switching, and visual shell modes.",
  tooling:
    "Utility commands, search, navigation, and operator productivity tools.",
