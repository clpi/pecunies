...
check('autocomplete has filtering and tab completion', appSource.includes('buildSuggestions') && (appSource.includes("event.key === 'Tab'") || appSource.includes('event.key === "Tab"')));
check('history handles arrow navigation', (appSource.includes("event.key === 'ArrowUp'") || appSource.includes('event.key === "ArrowUp"')) && (appSource.includes("event.key === 'ArrowDown'") || appSource.includes('event.key === "ArrowDown"')));
